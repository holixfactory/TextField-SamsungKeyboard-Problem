...
fun TextFieldContent(
    ...
    Column(
        ...
        Text(text = "${Typography.middleDot} compose(1.4.0-alpha02)", style = MaterialTheme.typography.body1)
        Text(text = "${Typography.middleDot} material3(1.0.1)", style = MaterialTheme.typography.body1)
